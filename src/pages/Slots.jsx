  ...
  return (
    <Box>
      ...
      <Grid templateColumns="repeat(5, 1fr)" gap={6} mb={8}>
        ...
        <SlotMachine name="Gates of Olympus" image="https://example.com/gates-of-olympus.jpg" balance={balance} setBalance={setBalance} />
        <SlotMachine name="Sweet Bonanza" image="https://example.com/sweet-bonanza.jpg" balance={balance} setBalance={setBalance} />
      </Grid>
    </Box>
  );
};

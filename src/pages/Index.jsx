...
const Index = () => {
  return (
    <Box>
      <Box bgImage="url('https://images.unsplash.com/photo-1592859865965-9c8c5e8f6a81?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')" bgPosition="center" bgRepeat="no-repeat" bgSize="cover" h="100vh" display="flex" alignItems="center">
        <Container maxW="container.lg">
          ...
          <Box textAlign="center">
            <Button as={Link} to="/slots" colorScheme="green" size="lg" mr={4}>
              Play Slots
            </Button>
